...
<ul class="post">
	<li class="float-left"><a href="#">Lorem</a></li>
	<li class="float-left"><a href="#">ipsum</a></li>
	<li class="float-left"><a href="#">dolor</a></li>
	<li class="float-left"><a href="#">sit amet</a></li>
